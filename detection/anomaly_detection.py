...
columns_used = joblib.load('c:/Users/aryan/Desktop/New folder/network-anomaly-new-main/model/columns_used.pkl')

# Load new data
new_df = pd.read_csv("c:/Users/aryan/Desktop/New folder/network-anomaly-new-main/data/live_traffic.csv")
...
isolation_forest = joblib.load('c:/Users/aryan/Desktop/New folder/network-anomaly-new-main/model/isolation_forest_model.pkl')
